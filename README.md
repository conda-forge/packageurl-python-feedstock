...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/packageurl-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14347&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/packageurl-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `packageurl-python` can be installed with:

```
conda install packageurl-python
```

It is possible to list all of the versions of `packageurl-python` available on your platform with:
